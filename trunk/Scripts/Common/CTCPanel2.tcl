...
#
# @section CTCPanel2_package Package provided
# 
# CTCPanel 2.0
...
#
  ...
  constructor {args} {
  ## @publicsection Build and install all component widgets and process configuration.
...
#    puts stderr "*** ${type}::constructor: win = $win, hull = $hull, self = $self"
  ...
  ## @privatesection Internal method to x scroll updates. Updates the scrolling for both
  ...
  ## @public Method to update one of the canvases scroll region. Bound to the
...
#    puts stderr "*** ==============================================="
  ...
  ## @publicsection Method to zoom the display by a zoom factor.
  ...
  method {create EndBumper} {name args} {
  ...
  # See EndBumper for defails.
    ...
    return [set Objects($name) [eval [list CTCPanel::EndBumper create $name $self $schematic] $args]]
  }
  ...
  method {create Crossover} {name args} {
  ...
  # See Crossover for defails.
    ...
    return [set Objects($name) [eval [list CTCPanel::Crossover create $name $self $schematic] $args]]
  }
  ...
  ## @protectedsection Method to check that a control point has been initialized.  Should
  ...
  ## @publicsection Display crosshairs on the schematic canvas.
  # @param ... Options:
  # @arg -xvar Global variable to receive the X result.
  # @arg -yvar Global variable to receive the Y result.
  # @par
...
#    puts stderr "*** $self controls crosshair: enabling crosshairs"
  ...
  ## @privatesection Used save the old grab.
  variable _ch_oldfocus {}
  ## Used save the old focus.
  method _crosshairStart {canvas xvar yvar} {
  ## Start using the crosshairs.
  # @param canvas The canvas the crosshairs are on.
  # @param xvar The name of the global variable to receive the X result.
  # @param yvar The name of the global variable to receive the Y result.
...
#    puts stderr "*** $self _crosshairMove: coords CROSSHAIRY: [$canvas coords CROSSHAIRY]"
  ...
  ## Bound to left button down.  Ends crosshairs and returns the results.
  # @param canvas The canvas the crosshairs are on.
  # @param xvar The name of the global variable to receive the X result.
  # @param yvar The name of the global variable to receive the Y result.
  # @param mx The X mouse position.
...
#
  ...
  ## @privatesection Polygon coordinates for the plate.
  ...
  ## @publicsection Construct a SWPlate object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The control panel canvas to draw the switch plate on.
  # @param ... Option list.
...
#
  ...
  ## The canvas component (parent widget component).
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a SIGPlate object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The control panel canvas to draw the switch plate on.
  # @param ... Option list.
...
#
  ...
  component ctcpanel
  ## @privatesection The CTC Panel component (parent widget).
  component canvas
  ## The canvas component (parent widget component).
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Code Button object.
  # @param _ctcpanel The CTCPanel megawidget.
...
#
  ...
  ## @privatesection Method to validate an orientation option of horizontal or vertical.
  ...
  ##
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a toggle switch object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The control panel canvas to draw the Code Button on.
  # @param ... Option list.
...
#    puts stderr "*** CTCPanel::Toggle_Create: bindings on $canvas $tag: [$canvas bind ${tag}_internal]"
  ...
  ## @privatesection Method to add (draw) a toggle switch lever.
  # @param pos The lever's position (Left, Right, or Center).
  ...
  method getv  {} {
  ## @publicsection Method to get our value (lever position).
...
#
  ...
  ## @privatesection Method to update the lamp color
  ...
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Lamp object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The control panel canvas to draw the Lamp on.
  # @param ... Option list.
...
#
  ...
  method _configureLabel {option value} {
  ## @privatesection Method to update the label option.
  ...
  ## The canvas component (parent widget component).
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a PushButton object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The control panel canvas to draw the PushButton on.
  # @param ... Option list.
...
#
  ...
  CTCPanel::verifyColorMethod
  method _configureColor {option value} {
  ## @privatesection Method to update the color of the label.
  ...
  ## The canvas component (parent widget component).
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Label object.
  # @param _ctcpanel The CTCPanel megawidget.
...
#
  ...
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Switch object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the Switch on.
  # @param ... Option list.
...
#
  ...
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Signal object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the Signal on.
  # @param ... Option list.
...
#
  ...
  ## The canvas component (parent widget component).
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a StraightBlock object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the StraightBlock on.
  # @param ... Option list.
...
# 
  ...
  ##
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a ScissorCrossover object.
  # @param _ctcpanel The CTCPanel megawidget.
  ...
  # @param ... Option list.
    ...
    $type _SchematicDrawDot  $canvas  0  0        no $options(-orientation) [list $tag ${tag}_E $cp]
    $type _SchematicDrawLine $canvas  0  0 20   0 no $options(-orientation) [list $tag $cp]
    $type _SchematicDrawLine $canvas 20  5 20  -5 no $options(-orientation) [list $tag $cp]
    $canvas move   $tag $x $y
    set bbox [$canvas bbox ${tag}]
    switch -exact -- $options(-position) {
      above {
...
#
  ...
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a CurvedBlock object.  See @FinnApr04@ for an explaination of 
  # the underlying math.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the CurvedBlock on.
  # @param ... Option list.
...
snit::type Crossover {
## @brief Crossover (turnout) object type.
#
# These are on the schematic and represent a Crossover on the Schematic.
# @param _ctcpanel The CTCPanel megawidget.
# @param _canvas The schematic canvas to draw the switch on.
# @param ... Options:
# @arg -x The x coordinate of the object (readonly, default 0).
...
#
  ...
  ## The state of the points.
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Crossover object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the Crossover on.
  # @param ... Option list.
    ...
    $type _SchematicDrawLine $canvas  0  0 16  0 $options(-flipped) $options(-orientation) [list $tag $cp]
    $type _SchematicDrawLine $canvas  0 20 40 20 $options(-flipped) $options(-orientation) [list $tag $cp]

    $type _SchematicDrawLine $canvas 16  0 26  0 $options(-flipped) $options(-orientation) [list $tag ${tag}_Normal $cp]
    $type _SchematicDrawLine $canvas 16  0 26  6 $options(-flipped) $options(-orientation) [list $tag ${tag}_Reverse $cp]

#    $type _SchematicDrawLine $canvas 16 20 40 20 $options(-flipped) $options(-orientation) [list $tag ${tag}_Normal $cp]
#    $type _SchematicDrawLine $canvas 16 20 26 14 $options(-flipped) $options(-orientation) [list $tag ${tag}_Reverse $cp]

    $type _SchematicDrawLine $canvas 26  0 60  0 $options(-flipped) $options(-orientation) [list $tag $cp]
#    $type _SchematicDrawLine $canvas 26 20 40 20 $options(-flipped) $options(-orientation) [list $tag $cp]
...
#
  ...
  CTCPanel::trackworkmethods
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a Crossing object.
  # @param _ctcpanel The CTCPanel megawidget.
...
#
  ...
  ## The state of the points.
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a SingleSlip object.
  # @param _ctcpanel The CTCPanel megawidget.
...
#
  ...
  ## The state of the points.
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a DoubleSlip object.
  # @param _ctcpanel The CTCPanel megawidget.
...
#
  ...
  ## The state of the points.
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a ThreeWaySW object.
  # @param _ctcpanel The CTCPanel megawidget.
...
#
  ...
  CTCPanel::trackworkmethods
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a HiddenBlock object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the HiddenBlock on.
  # @param ... Option list.
...
#
  ...
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a StubYard object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the StubYard on.
  # @param ... Option list.
...
#
  ...
  constructor {_ctcpanel _canvas args} {
  ## @publicsection Construct a ThroughYard object.
  # @param _ctcpanel The CTCPanel megawidget.
  # @param _canvas The schematic canvas to draw the ThroughYard on.
  # @param ... Option list.
