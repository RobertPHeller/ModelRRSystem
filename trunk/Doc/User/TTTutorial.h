...
/** @page timetable:Tutorial Time Table (V2) Tutorial
 * 
 ...
 * 
 * @section timetable:tut:crenew Creating a new time table
 * 
 ...
 * 
 * @subsection timetable:tut:crestat Creating stations
 * 
 ...
 * the dialog. 
 * 
 * @subsection timetable:tut:crecab Creating cabs
 * 
 ...
 * 
 * @section timetable:tut:cretrain Creating trains
 * 
 ...
 * train.
 * 
 * @section timetable:tut:print Printing a time table
 * 
