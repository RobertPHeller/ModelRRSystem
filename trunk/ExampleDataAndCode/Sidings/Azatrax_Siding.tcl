#!/usr/bin/wish
# Generated code: Sun Jul 26 15:48:43 EDT 2015
...
MainWindow ctcpanel create Signal Signal1 \
	-x 65.0 \
	-y 190.0 \
	-label {} \
	-controlpoint CP1 \
	-orientation 0 \
	-heads 2
MainWindow ctcpanel create Signal Signal2 \
	-x 665.0 \
	-y 165.0 \
	-label {} \
	-controlpoint CP2 \
	-orientation 4 \
	-heads 2
MainWindow ctcpanel create Signal Signal1Ra \
	-x 150.0 \
	-y 170.0 \
	-label {} \
	-controlpoint CP1 \
	-orientation 4 \
	-heads 1
MainWindow ctcpanel create Signal Signal2Ra \
	-x 570.0 \
	-y 195.0 \
	-label {} \
	-controlpoint CP2 \
	-orientation 0 \
	-heads 1
MainWindow ctcpanel create Signal Signal1Rb \
	-x 150.0 \
	-y 150 \
	-label {} \
	-controlpoint CP1 \
...
MainWindow ctcpanel create Signal Signal2Rb \
	-x 570.0 \
	-y 170.0 \
	-label {} \
	-controlpoint CP2 \
...
MainWindow ctcpanel create SIGPlate SignalPlate1 \
	-x 190.0 \
	-y 80.0 \
	-label 1 \
	-controlpoint CP1 \
...
MainWindow ctcpanel create CodeButton Code2 \
	...
	-controlpoint CP2 \
	-command {code2 code}
MainWindow ctcpanel create SIGPlate SignalPlate2 \
	-x 520.0 \
	-y 80.0 \
	-label 2 \
	-controlpoint CP2 \
