 ...
 * and see also SignalDriverMax72xx.zip, which contains the PCB 
 * Layout/assembly). This manual describes how I built these signals and how 
 * I will control them from my Linux computer, using a CTC panel created with 
 * my Model Railroad System Dispatcher program.
 * 
 */
