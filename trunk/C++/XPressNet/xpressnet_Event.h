...
private:
	...
	/**  Last response type.
	  */
	CommandStationResponse::TypeCode last_response_type;
#endif	
};
...
Tcl_Obj* xpressnet::NewSWIGLI100VersionNumbers(Tcl_Interp *interp,void * response) {
	return SWIG_NewInstanceObj(response,SWIGTYPE_p_xpressnet__LI100VersionNumbers,0);
}
Tcl_Obj* xpressnet::NewSWIGLI101XPressNetAddress(Tcl_Interp *interp,void * response) {
	return SWIG_NewInstanceObj(response,SWIGTYPE_p_xpressnet__LI101XPressNetAddress,0);
}
...
extern Tcl_Obj* NewSWIGLI100VersionNumbers(Tcl_Interp *interp,void * response);
extern Tcl_Obj* NewSWIGLI101XPressNetAddress(Tcl_Interp *interp,void * response);
#endif
