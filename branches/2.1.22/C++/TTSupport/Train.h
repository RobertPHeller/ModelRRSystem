...
/** This class implements a stop.  This specifies the station the train goes
...
class Stop {
public:
	/** Type of stop.  Origin for originating trains, Terminate for
	...
	/** Return departure time.  This is just the layover period added to
	  * the arrival time.
...
/** This class implements a train.  A train travels down the track passing or
