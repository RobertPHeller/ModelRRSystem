...
catch {TimeTable::SplashWorkMessage {Loading Station Code} 55}
...
$TimeTable::Main menu add view command -label {View One Station} \
			      -command TimeTable::ViewOneStation \
	 		      -dynamichelp "View a single station" \
			      -state disabled
$TimeTable::Main menu add view command -label {View All Stations} \
			      -command TimeTable::ViewAllStations \
			      -dynamichelp "View all stations" \
			      -state disabled
$TimeTable::Main menu add stations command -label {Set Duplicate Station} \
				  -command TimeTable::SetDuplicateStationIndex \
				  -dynamichelp "Set Duplicate Station"
$TimeTable::Main menu add stations command -label {Clear Duplicate Station} \
				  -command TimeTable::ClearDuplicateStationIndex \
				  -dynamichelp "Clear Duplicate Station"
$TimeTable::Main menu add stations command -label {Add Storage Track} \
...
$TimeTable::Main toolbar addbutton tools addStorageTrack \
			...
			-command TimeTable::AddStorageTrack \
			-helptext "Add Storage Trac" -state disabled
}
