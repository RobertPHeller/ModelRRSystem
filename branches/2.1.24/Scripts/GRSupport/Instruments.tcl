...
#@Chapter:Instruments.tcl -- Old (depreciated) Instruments code.
# $Id$

package require grsupport 1.0

global PI 
# Variable bound to pi (3.14159...).
# [index] PI!variable

global PI2
# Variable bound to pi/2 (1.57079...).
# [index] PI2!variable
...
# Procedure to convert from degrees to radians.
# <in> degrees Value to convert to radians.
# [index] DegreesToRadians!procedure
