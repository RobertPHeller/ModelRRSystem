...
/** @name  Time Table C++ support class library.
  * @doc 
  ...
  * The class includes a method to generate a \TEX{\LaTeX\ } file, which can
  * be processed by \TEX{\LaTeX\ } to create a formatted timetable which can
  * be printed.  It is assumed that the #TimeTable.sty# is available for
  * inclusion by the \TEX{\LaTeX\ } system.
  *
  * The ideas and structure of this code was heavily influenced by Bruce
  * Chubb's Kalmbach book, 
  * \textit{How to Operate Your Model Railroad}\TEX{\cite{Chubb77}}.
  */
