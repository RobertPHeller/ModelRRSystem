...
# $Id: CTCPanelWindow.tcl 667 2008-07-27 12:51:53Z heller $
...
#      puts stderr "*** $self close"
	...
	return
      ...
      puts $fp {# Generated by: $Id: CTCPanelWindow.tcl 667 2008-07-27 12:51:53Z heller $}
...
#      puts stderr "*** $self draw $args"
  ...
  snit::widgetadaptor EditUserCodeDialog {
    ...
    constructor {args} {
      ...
      $hull add -name cancel -text Cancel -command [mymethod _Cancel]
      wm protocol [winfo toplevel $win] WM_DELETE_WINDOW [mymethod _Cancel]
      $hull add -name help -text Help -command {BWHelp::HelpTopic EditUserCodeDialog}
      set frame [$hull getframe]
