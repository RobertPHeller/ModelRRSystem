...
Main window.  Consists of:
  <tlCamerascripts.#menubar> -- Menu bar
  <tlCamerascripts.main.frame.canvasSW.lensCanvas> -- Lens viewing area diagram.
  <tlCamerascripts.main.frame.bottom> -- Input area.
  <tlCamerascripts.main.status> -- Status area.
1 tlCamerascripts.#menubar
...
1 tlCamerascripts.main.frame.canvasSW.lensCanvas
This is where the lens view diagram is drawn.
1 tlCamerascripts.main.frame.bottom
