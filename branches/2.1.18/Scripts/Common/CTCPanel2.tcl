...
#    puts stderr "*** ==============================================="
  ...
  # <in> cp (optional) The name of control point to return the object of.
  #      If cp is the empty string, return all objects.
  # <in> class (optional) The class of objects to return.
  ...
  # <in> name The name of the push button.
  # <in> args The argument list for the object constructor.
  # <>
  # See ?CTC:PushButtonType? for defails.
  ...
  # <in> name The name of the signal.
  # <in> args The argument list for the object constructor.
  # <>
  # See ?CTC:SignalType? for defails.
...
# [label]CTC:PushButtonType
# PushButton object type.
# These are on the control panel and represent simple push buttons.
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The control panel canvas to draw the PushButton on.
# <option> -x The x coordinate of the object (readonly, default 0).
# <option> -y The y coordinate of the object (readonly, default 0).
# <option> -controlpoint The name of the control point this PushButton is part of
#         (readonly, default CP1).
# <option> -color The color of the PushButton (default white).
# <option> -label The label of the PushButton (default "PushButton").
# <option> -command The Tcl script to run when the PushButton button is pushed.
# <>
# Defined coords terminals: none.^
# Defined values (states): none.^
# Defined indicators:
# <I> -color if on.
  ...
  # <in> newstate The new PushButton state.
  }
  CTCPanel::standardMethods
  method geti  {ind} {
  # Method to get the state of one of our indicators.
...
# Defined indicators: none.
  ...
  # <in> _ctcpanel The CTCPanel megawidget.
  # <in> _canvas The control panel canvas to draw the CTCLabel on.
  # <in> args Option list.
...
# Defined indicators: none.
  ...
  # Construct a Label object.
  # <in> _ctcpanel The CTCPanel megawidget.
  # <in> _canvas The schematic canvas to draw the SchLabel on.
  # <in> args Option list.
...
snit::type Signal {
# [label]CTC:SignalType
# Signal (turnout) object type.
# These are on the schematic and represent a Signal on the Schematic.
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The schematic canvas to draw the Signal on.
# <option> -x The x coordinate of the object (readonly, default 0).
# <option> -y The y coordinate of the object (readonly, default 0).
# <option> -controlpoint The name of the control point this label is part of
#         (readonly, default CP1).
# <option> -label The label of the Signal (default "1").
# <option> -orientation The orientation (8-way) of the Signal (readonly, 
#		default 0).
# <option> -heads The number of heads (1, 2, or 3) of the Signal (readonly, default 1)
# <>
# Defined coords terminals: none.^
...
# Defined indicators: none.
  ...
  # <in> x1 The first X coordinate.
  # <in> y1 The first Y coordinate.
  # <in> dia The diameter of the oval.
  # <in> orientation The orientation (8-way).
  # <in> tags The canvas tags to include.
...
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The schematic canvas to draw the StraightBlock on.
...
# <option> -label The label of the StraightBlock (default "").
...
# These are on the schematic and represent a piece of track on the Schematic.
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The schematic canvas to draw the CurvedBlock on.
# <option> -x1 The first x coordinate of the object (readonly, default 0).
# <option> -y1 The first y coordinate of the object (readonly, default 0).
# <option> -x2 The second x coordinate of the object (readonly, default 0).
# <option> -y2 The second y coordinate of the object (readonly, default 0).
...
# <option> -controlpoint The name of the control point this label is part of
#         (readonly, default MainLine).
# <option> -label The label of the CurvedBlock (default "").
# <option> -position The position of the label (readonly, default below).
# <option> -occupiedcommand A command to run to find out if the block is
#		occupied (default {}).
# <>
...
# ScissorCrossover (turnout) object type.
...
# Defined indicators: none.
  ...
  # <in> _ctcpanel The CTCPanel megawidget.
  # <in> _canvas The schematic canvas to draw the ScissorCrossover on.
  # <in> args Option list.
...
# Defined indicators: none.
  ...
  # <in> _ctcpanel The CTCPanel megawidget.
  # <in> _canvas The schematic canvas to draw the SingleSlip on.
  # <in> args Option list.
...
# Defined indicators: none.
  ...
  # <in> _ctcpanel The CTCPanel megawidget.
  # <in> _canvas The schematic canvas to draw the DoubleSlip on.
  # <in> args Option list.
...
# Defined indicators: none.
  ...
  # <in> _ctcpanel The CTCPanel megawidget.
  # <in> _canvas The schematic canvas to draw the ThreeWaySW on.
  # <in> args Option list.
...
# These are on the schematic and represent a piece of track on the Schematic.
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The schematic canvas to draw the HiddenBlock on.
# <option> -x1 The first x coordinate of the object (readonly, default 0).
# <option> -y1 The first y coordinate of the object (readonly, default 0).
# <option> -x2 The second x coordinate of the object (readonly, default 0).
# <option> -y2 The second y coordinate of the object (readonly, default 0).
# <option> -controlpoint The name of the control point this label is part of
#         (readonly, default MainLine).
# <option> -label The label of the HiddenBlock (default "").
# <option> -position The position of the label (readonly, default below).
...
# <option> -occupiedcommand A command to run to find out if the HiddenBlock is
#		occupied (default {}).
# <>
# Defined coords terminals:
# <E1> First endpoint.
...
# These are on the schematic and represent a piece of track on the Schematic.
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The schematic canvas to draw the StubYard on.
# <option> -x The x coordinate of the object (readonly, default 0).
# <option> -y The y coordinate of the object (readonly, default 0).
# <option> -controlpoint The name of the control point this label is part of
#         (readonly, default Yard).
# <option> -label The label of the StubYard (default "1").
# <option> -position The position of the label (readonly, default below).
...
# <option> -occupiedcommand A command to run to find out if the StubYard is
#		occupied (default {}).
# <>
# Defined coords terminals:
# <Entry> Yard throat.
...
# These are on the schematic and represent a piece of track on the Schematic.
# <in> _ctcpanel The CTCPanel megawidget.
# <in> _canvas The schematic canvas to draw the ThroughYard on.
# <option> -x The x coordinate of the object (readonly, default 0).
# <option> -y The y coordinate of the object (readonly, default 0).
# <option> -controlpoint The name of the control point this label is part of
#         (readonly, default Yard).
# <option> -label The label of the ThroughYard (default "1").
# <option> -position The position of the label (readonly, default below).
# <option> -orientation The orientation (8-way) (readonly, default 0).
# <option> -flipped Whether the yard is flipped (readonly, default no).
# <option> -occupiedcommand A command to run to find out if the ThroughYard is
#		occupied (default {}).
# <>
# Defined coords terminals:
