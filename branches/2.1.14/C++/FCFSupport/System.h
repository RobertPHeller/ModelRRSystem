...
#ifdef SWIG
	const Station *FindStationByName(const char *name,const char *comment) const;
#else
	/** Station indexing (by name) function.  Returns NULL if the named
	  * station does not exist.
	  * @param name Station name to access.
	  */
	const Station *FindStationByName(string name,string comment) const;
#endif
...
public:
	...
	/** @memo Returns the list of division indexes.
	  * @args none
	  * @type list
	...
	/** @memo Returns the list of station indexes.
	  * @args none
	  * @type list
	...
	/** @memo Returns the list of train indexes.
	  * @args none
	  * @type list
	...
	/** @memo Returns the list of industry indexes.
	  * @args none
	  * @type list
	...
	/** @memo Returns the list of car types.
	  * @args none
	  * @type list
	...
	/** @memo Returns the list of owner initials.
	  * @args none
	  * @type list
