...
\index{Rail Driver|(}The PI Engineering Rail Driver Console is a
...
device.  The Model Railroad System includes a hotplug daemon\index{Rail
Driver!hotplug daemon}\index{USB hotplug daemon}, written using libusb, that interfaces with this
device.  The hotplug subsystem launches this user-mode
daemon\index{Rail Driver!user-mode daemon}, which connects to the Rail
...
\index{Rail Driver!Sample Tcl Client|(}
