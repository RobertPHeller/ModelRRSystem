...
catch {TimeTable::SplashWorkMessage {Loading Notes Code} 77}
...
$TimeTable::Main menu add view command -label {View One Note} \
			      -command TimeTable::ViewOneNote \
			      -dynamichelp "View one note" -state disabled
$TimeTable::Main menu add view command -label {View All Notes} \
			      -command TimeTable::ViewAllNotes \
			      -dynamichelp "View all notes" -state disabled
$TimeTable::Main menu add notes command -label {Create New Note} \
			       -command TimeTable::CreateNewNote \
			       -dynamichelp "Create new note"
$TimeTable::Main buttons add -name createNote -text {Create New Note} -anchor w \
				-command TimeTable::CreateNewNote \
				-helptext "Create new note" -state disabled
...
$TimeTable::Main menu add notes command -label {Edit Existing Note} \
			       -command TimeTable::EditExistingNote \
			       -dynamichelp "Edit existing note"
$TimeTable::Main buttons add -name editNote -text {Edit Existing Note} -anchor w \
				-command TimeTable::EditExistingNote \
				-helptext "Edit existing note" -state disabled
...
$TimeTable::Main menu add notes command -label {Add note to train} \
			       -command TimeTable::AddNoteToTrain \
			       -dynamichelp "Add note to train"
$TimeTable::Main buttons add -name addNoteToTrain -text {Add note to train} -anchor w \
				-command TimeTable::AddNoteToTrain \
				-helptext "Add note to train" -state disabled
...
$TimeTable::Main menu add notes command -label {Add note to train at station stop} \
...
$TimeTable::Main menu add notes separator
$TimeTable::Main menu add notes command -label {Remove note from train} \
			       -command TimeTable::RemoveNoteFromTrain \
			       -dynamichelp "Remove note from train"
$TimeTable::Main buttons add -name removeNoteFromTrain -text {Remove note from train} \
				-anchor w \
				-command TimeTable::RemoveNoteFromTrain\
				-helptext "Remove note from train" -state disabled
...
$TimeTable::Main menu add notes command -label {Remove note from train at station stop} \
...
$TimeTable::Main buttons add -name removeNoteFromTrainAtStation \
				...
				-anchor w \
				-command TimeTable::RemoveNoteFromTrainAtStation\
				-helptext "Remove note from train at station stop" -state disabled
