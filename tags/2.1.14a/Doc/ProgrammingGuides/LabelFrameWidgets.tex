...
\begin{enumerate}
\index{LabelFrame Widgets!BWFileEntry}\index{BWFileEntry|see{LabelFrame Widgets, BWFileEntry}}
\item \lstinline=BWFileEntry= defines the \lstinline=FileEntry= widget,
which is meant to enter file and directory names.
\index{LabelFrame Widgets!BWLabelComboBox}\index{BWLabelComboBox|see{LabelFrame Widgets, BWLabelComboBox}}
...
\index{LabelFrame Widgets!BWLabelSpinBox}\index{BWLabelSpinBox|see{LabelFrame Widgets, BWLabelSpinBox}}
...
\lstinline=Entry= widget.
\index{LabelFrame Widgets!LabelSelectColor}\index{LabelSelectColor|see{LabelFrame Widgets, LabelSelectColor}}
