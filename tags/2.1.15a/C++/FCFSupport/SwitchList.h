...
/** @name operator<<
  * @args (ostream& stream, const SwitchListElement& element)
  * @type ostream&
  * @memo SwitchListElement&
  * @doc Output stream operator for SwitchListElements.
  * @param stream The output stream.
  * @param element The switch list element to output.
  */
ostream& operator<< (ostream& stream,const SwitchListElement& element);
/** @name SwitchListElementVector
...
public:
	...
	/** Return the pick index.
	  */
	int PickIndex() const {return pickIndex;}
