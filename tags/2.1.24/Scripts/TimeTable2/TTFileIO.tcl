...
proc TimeTable::LoadTimeTable {{filename {}}} {
  ...
  $Main menu entryconfigure file {Save As...}  -state normal
  EnableTrainCommands
...
snit::type TimeTable::CreateANewTimeTableDialog {
  ...
  typemethod createDialog {} {
    ...
    $dialog add -name help -text Help -command [list HTMLHelp::HTMLHelp help {Create A New Time Table Dialog}]
...
$TimeTable::Main menu entryconfigure file New -command TimeTable::NewTimeTable -state normal \
...
$TimeTable::Main menu entryconfigure file {Open...} -command TimeTable::LoadTimeTable \
...
$TimeTable::Main menu entryconfigure file {Save} -command TimeTable::SaveTimeTable -state disabled \
...
$TimeTable::Main toolbar addbutton tools save -image SaveButtonImage -command TimeTable::SaveTimeTable \
	-helptext "Save the current Time Table" -state disabled
$TimeTable::Main menu entryconfigure file {Save As...} -command TimeTable::SaveTimeTableAs \
	-state disabled -dynamichelp "Save the current Time Table in a new file"
