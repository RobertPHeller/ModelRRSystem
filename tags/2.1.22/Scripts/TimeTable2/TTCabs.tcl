...
catch {TimeTable::SplashWorkMessage {Loading Cab Code} 66}
...
snit::type TimeTable::createAllCabsDialog {
  ...
  typemethod createDialog {} {
    ...
    $_MainDialog add -name help -text Help -command [list HTMLHelp::HTMLHelp help {Create All Cabs Dialog}]
...
snit::type TimeTable::addCabDialog {
  ...
  typemethod createDialog {} {
    ...
    $dialog add -name help -text Help -command [list HTMLHelp::HTMLHelp help {Add Cab Dialog}]
...
$TimeTable::Main menu add cabs command -label {Add A Cab} \
			      -command TimeTable::AddCab \
			      -dynamichelp "Add a cab"
$TimeTable::Main buttons add -name addACab -text {Add A Cab} -anchor w \
			      -command TimeTable::AddCab \
			      -helptext "Add a cab" -state disabled
