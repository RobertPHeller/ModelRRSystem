...
/** @memo Track Graph class, which encapsulates the track graphs.
  * @doc Holds the two track graphs, an uncompressed, directed graph built
...
public:
	...
	/** Returns the length of an edge.
	  */
	float EdgeLength(int nid, int edgenum);
