...
/** PDF File support structures. These classes and structures are
  designed to implement the functionallity described in Adobe's PDF
  Reference Fifth Edition version 1.6.
 */
namespace PDFFileStructures {
	/** The cross reference table object.  Used to manage indirect objects.
	 */
	class CrossReferenceTable {
	public:
		friend class IndirectObject;
		/// Constructor.  Create a fresh cross reference table.
		CrossReferenceTable();
		/// Destructor.  Clean everthing up.
		~CrossReferenceTable() {}
...
private:
	...
	public:
		/** Constructor.  Perform base initialization.
	...
	/** A deleted indirect object.  Just a place holder in the linked list
	    of freed indirect objects.
	 */
	class FreedObject : public IndirectObject {
	public:
		/** Constructor.  Create a freed object.
	...
	public:
		/** Constructor.  Create a new dictonary.
		  @param objNum The next object number.
		  @param genNum The generation number.
		  @param tab The cross reference table we are in.
		 */
	...
	public:
		/** Constructor.  Set the type member.
	...
	public:
		/** Constructor.  Create a fresh Rectangle object.
