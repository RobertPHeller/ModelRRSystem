...
/** XTrkCAD Classes.
  ...
  Various classes used by the XTrkCAD parser.  These classes are used to
...
The track plan is loaded into a graph representation, where each node is
one logical piece of trackwork.
  */
