...
proc ChartDisplay::addATrain { path timetable train} {
  ...
  set stortags [list Storage Storage:Train "Storage:Train:[Train_Number $train]" "Train:[Train_Number $train]"]
...
proc MainWindow {dontWithdraw} {
  ...
  $Main menu add options command \
	...
	-command [list TimeTableConfiguration write ~/.timeTable] \
	-dynamichelp "Save the system configuration"
  $Main menu add options command \
	-label {Re-load System Configuration} \
	-command [list TimeTableConfiguration read ~/.timeTable] \
  ...
  $Main buttons add -name quit -anchor w -text {Quit -- Exit NOW} \
		      -command CarefulExit -underline 0 \
...
snit::type TtYesNo {
  ...
  typeconstructor {
    set dialog [Dialog::create .ttYesNo -class TtYesNo -bitmap questhead \
...
snit::type TtErrorMessage {
  ...
  typeconstructor {
    set dialog [Dialog::create .ttErrorMessage -class TtErrorMessage \
...
snit::type TtWarningMessage {
  ...
  typeconstructor {
    set dialog [Dialog::create .ttWarningMessage -class TtWarningMessage \
...
snit::type TtInfoMessage {
  ...
  typeconstructor {
    set dialog [Dialog::create .ttInfoMessage -class TtInfoMessage \
...
#      puts stderr "*** ${self}::constructor: constructtopframe failed: $message"
  ...
  method draw {args} {
    catch [concat $self initializetopframe $userframe $args]
    update idle
