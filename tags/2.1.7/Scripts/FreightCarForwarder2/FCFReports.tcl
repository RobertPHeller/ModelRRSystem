...
proc ReportCarTypes {reportType} {
  ...
  TheSystem ReportCarTypes $reportType [Printer cget -this]
}
...
snit::type EnterOwnerInitialsDialog {
  ...
  typeconstructor {
    set dialog [Dialog::create .enterOwnerInitialsDialog \
		    -class EnterOwnerInitialsDialog -bitmap questhead \
    ...
    $dialog add -name help -text Help \
		-command [list BWHelp::HelpTopic EnterOwnerInitialsDialog]
