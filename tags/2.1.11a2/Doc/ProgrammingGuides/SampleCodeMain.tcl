...
namespace eval SampleCode {
  ...
  variable LogWindow;#		Log window	

  # Create the main window
  pack [set Main [mainwindow .main -dontwithdraw no]] -expand yes -fill both
  ...
  $Main toolbar addbutton tools close -image CloseButtonImage -command SampleCode::CarefulExit
