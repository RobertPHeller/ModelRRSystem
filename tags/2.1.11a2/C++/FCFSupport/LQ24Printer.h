...
private:
	...
	/** @memo Special character codes.
	  * These character codes introduce various special printer functions
	  * and modes.
	  */
	enum ChCodes {
		/** @memo Form feed.
		  * @doc This code causes a page feed.
		  */		
		FF = 12,
		/** @memo Shift In
		  * @doc This character starts condensed (half width) spacing.
		  */
		SI = 15,
		/** @memo Device control 2.
		  * @doc This character ends condensed (half width) spacing.
		  */
		DC2 = 18,
		/** @memo Escape.
		  * @doc This character is used to introduce a number of escape
