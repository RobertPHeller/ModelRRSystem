...
class IntegerList {
private:
	//@ManDoc: The current element.
	int iElt;
	//@ManDoc: The pointer to the next element.
	IntegerList *next;
public:
	...
	//@ManDoc: Add an element to the {\em end} of the list.
	...
	//@ManDoc: Element accessor.
	int Element() const {return iElt;}
	//@ManDoc: Next pointer accessor.
