...
/** @name XPressNet C++ Serial Port Interface.
...
/** @memo Base response class.
  * @doc All responses are derived from this class.
  */
...
public:
	...
	/** @memo Default destructor (never called).
	  */
...
/** @memo Programming info.
    @doc A ``short-circuit'' was detected.
  */
...
/** @memo Programming info.
  * @doc The ``data byte not was not found''.
  */
...
/** @memo Programming info.
  * @doc The ``command station is busy''.
  */
...
/** @memo Programming info.
  * @doc The ``command station is ready''.
  */
...
/** @memo Main XPressNet interface class.
  * @doc This class implements the interface logic
