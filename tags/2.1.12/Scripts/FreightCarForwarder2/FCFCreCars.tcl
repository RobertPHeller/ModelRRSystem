...
proc FCFCreCars::AddCar {} {
  ...
  grid [Button::create $CarsListFR.delete$CarsListIndex -text "Delete" \
...
proc FCFCreCars::ValidateCarsFile {} {
  ...
  for {set i 0} {$i < $CarsListIndex} {incr i} {
	...
	tk_messageBox -type ok -icon error -message "Invalid division symbol ($ds) for car $RR $NUM!"
	incr invalid
      }
    }
    set loc [$CarsListFR.loc$i cget -text]
    if {![FCFCreIndustries::ValidIndustry $loc]} {
      tk_messageBox -type ok -icon error -message "Invalid location ($loc) for car $RR $NUM!"
      incr invalid
    }
    set dest [$CarsListFR.dest$i cget -text]
    if {![FCFCreIndustries::ValidIndustry $loc]} {
      tk_messageBox -type ok -icon error -message "Invalid destination ($dest) for car $RR $NUM!"
      incr invalid
    }
    incr Cars
  }
...
proc FCFCreCars::FCFCreCarTypes {notebook} {
  variable CarTypesPage [$notebook insert end cartypes \
				-text "CarTypes File" -state disabled]
  ...
  set ctLF [LabelFrame::create $frame.ctLF -text "Car Types:" -side top]
  pack $ctLF -fill x
  set ctLFfr [$ctLF getframe]
  variable CarTypesListFR [frame $ctLFfr.carTypesListFR]
  pack $CarTypesListFR -expand yes -fill both
  grid [Label::create $CarTypesListFR.typeHead -text {T}] \
	-row 0 -column 0 -sticky nw
  grid [Label::create $CarTypesListFR.commaAHead -text {,}] \
	-row 0 -column 1 -sticky nw
  grid [Label::create $CarTypesListFR.groupHead -text {G}] \
	-row 0 -column 2 -sticky nw
  grid [Label::create $CarTypesListFR.commaBHead -text {,}] \
	-row 0 -column 3 -sticky nw
  grid [Label::create $CarTypesListFR.descrHead -text {Description}] \
	-row 0 -column 4 -sticky nw
  ...
  grid [Label::create $CarTypesListFR.commaDHead -text {,}] \
	-row 0 -column 7 -sticky nw
  grid [Label::create $CarTypesListFR.commentHead -text {Comment}] \
	-row 0 -column 8 -sticky nw
  ...
  set cgLF [LabelFrame::create $frame.cgLF -text "Car Groups:" -side top]
  pack $cgLF -fill x
  set cgLFfr [$cgLF getframe]
  variable CarGroupsListFR [frame $cgLFfr.carGroupsListFR]
  pack $CarGroupsListFR -expand yes -fill both
  variable CarGroupsListIndex 0
  grid [Label::create $CarGroupsListFR.groupHead -text {G}] \
	-row 0 -column 0 -sticky nw
  grid [Label::create $CarGroupsListFR.commaAHead -text {,}] \
	-row 0 -column 1 -sticky nw
  grid [Label::create $CarGroupsListFR.descHead -text {Description}] \
	-row 0 -column 2 -sticky nw
  grid [Label::create $CarGroupsListFR.commaBHead -text {,}] \
	-row 0 -column 3 -sticky nw
  grid [Label::create $CarGroupsListFR.commentHead -text {Comment}] \
	-row 0 -column 4 -sticky nw
  grid columnconfigure $CarGroupsListFR 4 -weight 1
  grid [Label::create $CarGroupsListFR.deleteHead -text {Delete?}] \
	-row 0 -column 5 -sticky nw
  pack [Button::create $cgLFfr.addCarGroup -text {Add Car Group} \
					   -command FCFCreCars::AddCarGroup] \
	-anchor w

  set hzLF [LabelFrame::create $frame.hzLF -text "Hazard Classes:" -side top]
  pack $hzLF -fill x
  ...
  grid [Label::create $HazardListFR.commaAHead -text {,}] \
	-row 0 -column 1 -sticky nw
  grid [Label::create $HazardListFR.descHead -text {Hazard}] \
	-row 0 -column 2 -sticky nw
  grid [Label::create $HazardListFR.commaBHead -text {,}] \
	-row 0 -column 3 -sticky nw
  grid [Label::create $HazardListFR.cargoHead -text {Typical cargo}] \
	-row 0 -column 4 -sticky nw
  grid [Label::create $HazardListFR.commaCHead -text {,}] \
	-row 0 -column 5 -sticky nw
  grid [Label::create $HazardListFR.commentHead -text {Comment}] \
	-row 0 -column 6 -sticky nw
  grid columnconfigure $HazardListFR 6 -weight 1
  grid [Label::create $HazardListFR.deleteHead -text {Delete?}] \
	-row 0 -column 7 -sticky nw
  pack [Button::create $hzLFfr.addHazard -text {Add Hazard} \
					   -command FCFCreCars::AddHazard] \
	-anchor w

  set wtLF [LabelFrame::create $frame.wtLF -text "Weight Classes:" -side top]
  pack $wtLF -fill x
  ...
  grid [Label::create $WeightListFR.commaAHead -text {,}] \
	-row 0 -column 1 -sticky nw
  grid [Label::create $WeightListFR.weightHead -text {Weight}] \
	-row 0 -column 2 -sticky nw
  grid [Label::create $WeightListFR.commaBHead -text {,}] \
	-row 0 -column 3 -sticky nw
  grid [Label::create $WeightListFR.commentHead -text {Comment}] \
	-row 0 -column 4 -sticky nw
  grid columnconfigure $WeightListFR 4 -weight 1
  grid [Label::create $WeightListFR.deleteHead -text {Delete?}] \
	-row 0 -column 5 -sticky nw
  pack [Button::create $wtLFfr.addWeight -text {Add Weight} \
					   -command FCFCreCars::AddWeight] \
	-anchor w

  set ptLF [LabelFrame::create $frame.ptLF -text "Clearence Plate Classes:" -side top]
  pack $ptLF -fill x
  ...
  grid [Label::create $PlateListFR.commaAHead -text {,}] \
	-row 0 -column 1 -sticky nw
  grid [Label::create $PlateListFR.descHead -text {Plate Code}] \
	-row 0 -column 2 -sticky nw
  grid [Label::create $PlateListFR.commaBHead -text {,}] \
	-row 0 -column 3 -sticky nw
  grid [Label::create $PlateListFR.commentHead -text {Comment}] \
	-row 0 -column 4 -sticky nw
  grid columnconfigure $PlateListFR 4 -weight 1
  grid [Label::create $PlateListFR.deleteHead -text {Delete?}] \
	-row 0 -column 5 -sticky nw
  pack [Button::create $ptLFfr.addPlate -text {Add Plate} \
...
proc FCFCreCars::AddCarGroup {} {
  ...
  if {$lastrow >= 17} {
    tk_messageBox -type ok -icon warning -message "16 Groups max!"
    return
  }
...
proc FCFCreCars::AddHazard {} {
  ...
  if {$lastrow > 9} {
    tk_messageBox -type ok -icon warning -message "9 Hazard types max!"
    return
  }
  ...
  grid [Button::create $HazardListFR.delete$HazardListIndex -text {Delete} \
...
proc FCFCreCars::AddWeight {} {
  ...
  if {$lastrow > 9} {
    tk_messageBox -type ok -icon warning -message "9 Weight Classes max!"
    return
  }
  ...
  grid [Entry::create $WeightListFR.comment$WeightListIndex -text] \
	-row $lastrow -column 4 -sticky new
  grid [Button::create $WeightListFR.delete$WeightListIndex -text {Delete} \
...
proc FCFCreCars::AddPlate {} {
  ...
  if {$lastrow > 9} {
    tk_messageBox -type ok -icon warning -message "9 Plate Classes max!"
    return
  }
  ...
  grid [Entry::create $PlateListFR.comment$PlateListIndex] \
	-row $lastrow -column 4 -sticky new
  grid [Button::create $PlateListFR.delete$PlateListIndex -text {Delete} \
...
proc FCFCreCars::ValidateCarTypesFile {ctType ctTypeDir} {
  ...
  switch $ctType {
	...
	incr invalid
	tk_messageBox -type ok -icon error -message "No car groups!"
      }
	...
	if {[lsearch $CarGroups [$CarTypesListFR.group$index cget -text]] < 0} {
	  incr invalid
	  tk_messageBox -type ok -icon error -message "Invalid group for car type [$CarTypesListFR.type$index cget -text]: [$CarTypesListFR.group$index cget -text]!"
	}
      }
      variable HazardListFR
      if {[lindex [grid size $HazardListFR] 1] < 2} {
	incr invalid
	tk_messageBox -type ok -icon error -message "No Hazard classes!"
      }
      variable WeightListFR
      if {[lindex [grid size $WeightListFR] 1] < 2} {
	incr invalid
	tk_messageBox -type ok -icon error -message "No Weight classes!"
      }
      variable PlateListFR
      if {[lindex [grid size $PlateListFR] 1] < 2} {
	incr invalid
	tk_messageBox -type ok -icon error -message "No Plate classes!"
      }
...
proc FCFCreCars::WriteCarTypes {directory ctfilename hzfilename ptfilename 
  ...
  switch $ctType {
	...
	file -force [file join "$FCFCreSystem::StockDataDir" "$ctTypeDir" "$fn"] \
		    "$directory"
      }
      return true
    }
