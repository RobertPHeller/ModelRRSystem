...
#@Chapter:Instruments2.tcl -- New style Instruments code, using Snit
#$Id$

namespace eval Instruments {
# Namespace used for instruments code.
# [index] Instruments!namespace
}

snit::macro Instruments::CommonOptions {defaultLabel} {
# Snit macro to define common options used by all instruments.
# <in> defaultLabel Default value for the label.
# <option> -x The X coordinate of the instrument (default 0).
# <option> -y The Y coordinate of the instrument (default 0).
# <option> -size The size of the instrument (default 100).
# <option> -label The label of the instrument.
# <option> -labelcolor The color of the label (default black).
# <option> -labelfont The font of the label (default {Times 14 bold}).
# <option> -background The background color of the instrument (default blue).
# <option> -outline The outline color of the instrument (default black).
# <option> -scaleback The background color of the scale (default white).
# <option> -scaleticks The color of the scale ticks (default black).
# <option> -fontfamily The font family used on the instrument (default Courier).
# [index] Instruments::CommonOptions!macro
  ...
  # <in> option The name of the option to configure.
  # <in> value The new value.
  # [index] _ConfigureFontFamily!method
...
# [index] Instruments!namespace
  ...
  # <option> -y The Y coordinate of the instrument (default 0).
  # <option> -size The size of the instrument (default 100).
  # <option> -label The label of the instrument (default DialInstrument).
  # <option> -labelcolor The color of the label (default black).
  # <option> -labelfont The font of the label (default {Times 14 bold}).
  # <option> -background The background color of the instrument (default blue).
  # <option> -outline The outline color of the instrument (default black).
  # <option> -scaleback The background color of the scale (default white).
  # <option> -scaleticks The color of the scale ticks (default black).
  # <option> -fontfamily The font family used on the instrument (default 
  #		Courier).
  # <option> -maxvalue The maximum value (default 100).
  # <option> -minvalue The minimum value (default 0).
  # <option> -minat The pointer position, in degrees, of the minimum value 
  #			(default 225).
  # <option> -maxat The pointer position, in degrees, of the maximum value
  #			(default 315).
  # <option> -pointercolor The color of the pointer (default black).
  # <option> -secondpointerp Should a second pointer be drawn (default no)?
  # <option> -secondpointercolor The color of the second pointer (default red).
  # <option> -scaleticksinterval The interval of the scale ticks (default 10).
  # <option> -digitalp Should a digital display also be included (default yes)?
  # <option> -digits How many digits for the digital display (default 3).
  # <option> -digitalbackground The background color of the digital display 
  #		(default white).
  # <option> -digitaldigitcolor The foreground folor of the digital display
  #		(default black).
  # [index] Instruments::DialInstrument!snit type
    ...
    # <in> _canvas The canvas to draw the DialInstrument on.
    # <in> args Option  list.
    ...
    # <in> value The value to set the instrument to.
    # <in> value2 The value for the second pointer.
  ...
  # <option> -y The Y coordinate of the instrument (default 0).
  # <option> -size The size of the instrument (default 100).
  # <option> -label The label of the instrument (default Clock).
  # <option> -labelcolor The color of the label (default black).
  # <option> -labelfont The font of the label (default {Times 14 bold}).
  # <option> -background The background color of the instrument (default blue).
  # <option> -outline The outline color of the instrument (default black).
  ...
  # <option> -fontfamily The font family used on the instrument (default 
  #		Courier).
  # <option> -hubcolor The color of the hub (default black).
  # <option> -minutehandcolor The color of the  minute hand (default black).
  # <option> -hourhandcolor The color of the hour hand (default black).
  # [index] Instruments::AnalogClock!snit type
    ...
    # <in> hour The hour, an integer between 1 and 12.
    # <in> minute The minute, an integer between 0 and 59.
  ...
  # <option> -y The Y coordinate of the instrument (default 0).
  # <option> -size The size of the instrument (default 100).
  # <option> -label The label of the instrument (default DigitalInstrument).
  # <option> -labelcolor The color of the label (default black).
  # <option> -labelfont The font of the label (default {Times 14 bold}).
  # <option> -background The background color of the instrument (default blue).
  # <option> -outline The outline color of the instrument (default black).
  ...
  # <option> -fontfamily The font family used on the instrument (default 
  #		Courier).
  # <option> -digitcolor The color of the digits (default black).
  # <option> -digits The number of digits (default 3).
  # [index] Instruments::DigitalInstrument!snit type
  ...
  #		Courier).
  # <option> -digitcolor The color of the digits (default black).
  # [index] Instruments::DigitalClock!snit type
  ...
  # <option> -y The Y coordinate of the instrument (default 0).
  # <option> -size The size of the instrument (default 100).
  # <option> -color The color of the lamp (default black).
  # <option> -outline The outline color of the instrument (default black).
  # [index] Instruments::CabSignalLamp!snit type
