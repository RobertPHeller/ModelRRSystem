...
#@Chapter:panedw.tcl -- Paned Window megawidget.
#$Id$
...
# PanedWindow::index
# ----------------------------------------------------------------------------
proc PanedWindow::index { path index } {
  variable _panedw
...
# ----------------------------------------------------------------------------
proc PanedWindow::paneconfigure { path index args } {
  variable _panedw
...
# ----------------------------------------------------------------------------
proc PanedWindow::panecget { path index option } {
  set index [$path index $index]
...
# ----------------------------------------------------------------------------
proc PanedWindow::Pane::configure { path option } {
...
# ----------------------------------------------------------------------------
proc PanedWindow::Pane::cget { path option } {
