...
#    puts stderr "*** ==============================================="
  ...
  method getv {name} {
  # Method to get the value of an object.
  ...
  # Method to set the value of an object.
  ...
  # <in> ind The indicator whose state is return.
  ...
  # <in> ind The indicator to update.
  # <in> value The new indicator value.
  ...
  # <in> tname The name of the part of the object to fetch the coordinates of.
...
# <option> -label The label of the switch (default "").
# <option> -position The position of the label (readonly, default below).
# <option> -bridgeorientation The orientation of the bridge (8-way) (readonly, default 0).
...
#		occupied (default {}).
  ...
  # <in> args Option list.
    ...
    set x2 $options(-x2)
    set y2 $options(-y2)
    set borientation $options(-bridgeorientation)
